...
int SC2Map::readMap()
{
  ...
  if( !SFileOpenArchive( fullArchiveName.data(), 0, STREAM_FLAG_READ_ONLY, &archive ) )
  {
...
int SC2Map::readGameStrings_txt( const HANDLE archive )
{
  ...
  char* bufferString = new char[bufferSize + 1];
  bufferString[bufferSize] = '\0';
  ...
  //char attributeName[] = "DocInfo/Author=";
  //char attributeName[] = "DocInfo/DescLong=";
  //char attributeName[] = "DocInfo/DescShort=";
  //char attributeName[] = "MapInfo/Player00=";
  ...
  // we did find a name
  intptr_t nameStartIndex = (intptr_t)findAttribute -
                       (intptr_t)bufferString  +
...

{
      ...
      // find terminator of third string
      while( buffpos < bufferSize && bufferFreeAfterUse[buffpos] != 0 )
      {
        ++buffpos;
      }
      ...
      // find terminator of fourth string
      while( buffpos < bufferSize && bufferFreeAfterUse[buffpos] != 0 )
      {
        ++buffpos;
      }
